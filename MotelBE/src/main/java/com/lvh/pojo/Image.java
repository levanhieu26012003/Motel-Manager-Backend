...
@NamedQueries({
    ...
    @NamedQuery(name = "Image.findByUpdatedDate", query = "SELECT i FROM Image i WHERE i.updatedDate = :updatedDate"),
    @NamedQuery(name = "Image.findByPublicUrl", query = "SELECT i FROM Image i WHERE i.publicUrl = :publicUrl")})
